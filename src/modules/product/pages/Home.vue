        ...
        <div class="header__top-content">
          <div class="row">
              ...
              <div class="col-sm-12 text-center home-content">
                        <h1>  <span>  </span></h1>
                        <h5> Vender &  Customer </h5>
                        <div>
                          <button class="btn btn-lg btn-outline-primary m-3 " style="color: white"> <router-link  to="/vender"> Vender </router-link > </button>
                          <button class="btn btn-lg btn-outline-primary"> <router-link to="/register"> Customer </router-link> </button>
                          <button class="btn btn-lg btn-outline-primary m-3"> <router-link to="/newproduct"> add product </router-link> </button>
                        </div>
                      </div>
              </div>
...
export default {
  ...
  data: () => ({
    slides: [
      { img: require('@/assets/img/slideshow/img1.jpg') },
      { img: require('@/assets/img/slideshow/img2.jpg') },
      { img: require('@/assets/img/slideshow/img3.jpg') },
      { img: require('@/assets/img/slideshow/img4.jpg') }
    ],
    slideShowIndex: 0,
    sliderInterval: null,
    progressWidth: 0
